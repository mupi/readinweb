 ...
 *
 */
public class TeacherJustificationProducer implements ViewComponentProducer {

    public static final String VIEW_ID = "justificativas";

    private static Log logger = LogFactory.getLog(TeacherJustificationProducer.class);
