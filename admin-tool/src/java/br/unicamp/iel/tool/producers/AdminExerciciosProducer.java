 ...
 *
 */
public class AdminExerciciosProducer implements ViewComponentProducer, ViewParamsReporter, NavigationCaseReporter {
    ...
    public void fillComponents(UIContainer tofill, ViewParameters viewparams,
        ...
        for(Exercise e : exercises){
            ...
            CourseViewParameters params = new CourseViewParameters(parameters.course, e.getId(),
                            parameters.activity);
    ...
    public List<NavigationCase> reportNavigationCases() {
        ...
        l.add(new NavigationCase(CourseComponents.UPDATED,
                new CourseViewParameters(AdminExerciciosProducer.VIEW_ID, false,
                        true, false)));
