...
public class CreateClassProducer implements ViewComponentProducer, NavigationCaseReporter {
    ...
    public void fillComponents(UIContainer tofill, ViewParameters viewparams,
        ...
        form.parameters.add(new UIELBinding("#{ManageClassBean.course}",
                course.getId()));
        ...
        UIInput.make(form, "weekly_activities",
                "#{ManageClassBean.weeklyActivities}")
                .setValue(Integer.toString(2));
